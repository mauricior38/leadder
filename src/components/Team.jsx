        ...
        <section className="team" id="team">
            <div className="container">
                ...
                <motion.div
                    ...
                    custom={2}
                >
                    <div className="team-premium__glow" />
                    <div className="team-premium__content">
                        <div className="team-premium__photo-wrapper">
                            <Image src="/CarlaPhoto.png" alt="Carla Lannes" className="team-premium__photo" width={180} height={180} />
                        </div>
                        <div className="team-premium__info">
                            <h3 className="team-premium__name">Carla Lannes</h3>
                            <span className="team-premium__role">CFO — Gestora Financeira</span>
                            <p className="team-premium__bio">
                            ...
                            <a href="https://www.linkedin.com/in/carla-da-s-o-lannes-9802a753/" target="_blank" rel="noopener noreferrer" className="team-premium__linkedin">
