  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-200 sm:text-7xl">
        Sua gestão{' '}
        <span className="relative whitespace-nowrap text-[#beaa6c]">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-yellow-800/70"
          ...
          <span className="relative">financeira</span>
        </span>{' '}
        descomplicada.
      </h1>
      ...
      {/* <div className="lg:mt-20 mt-40">
        <p className="font-display text-base text-neutral-300">
          Temos a confiança das seguintes empresas
        </p>
        <ul
          role="list"
